...
def merge_mean_per_class(eval_path, num_tasks,nb_classes):
    ...
    num_per_class = [0 for c in classes]
    ...
    num_per_class_path = os.path.join(eval_path, "num_per_class.pkl")
    with open(classwise_top1_path, 'wb') as file:
        pickle.dump(classwise_top1, file)
    with open(num_per_class_path, 'wb') as file:
