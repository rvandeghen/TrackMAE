...
def get_args():
    ...
    parser.add_argument('--crop_min', type=float, default=None)
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['Kinetics-400', 'SSV2', 'UCF101', 'HMDB51','image_folder','SSV2-Mini', 'Mini-Kinetics', 'Kinetics-25-percent'],
...
def main(args, ds_init):
    ...
    print(f"Rank {args.rank} reached barrier, distributed={args.distributed}")
    print(f"Rank {args.rank} using GPU {torch.cuda.current_device()}")
